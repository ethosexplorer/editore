...
import { Quote, Copy, Download, BookOpen, Globe, FileText, Search, Zap, Image, Video, Link, Hash, Upload, Trash2, Eye, History, CheckCircle } from 'lucide-react';
...
const CitationGeneratorPage: React.FC = () => {
  ...
  const sourceTypes = [
    ...
    { id: 'image', name: 'Image', icon: Image, count: 0 },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Generate APA 7th edition citations instantly with AI-powered accuracy</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">How would you like to add your source?</h3>
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-amber-500 text-white font-medium rounded-lg hover:bg-amber-600 transition-colors disabled:opacity-50 flex items-center"
            >
              {isProcessing ? (
                <>
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-700">Need to import multiple citations?</span>
              <button
                onClick={() => fileInputRef.current?.click()}
                className="flex items-center px-3 py-2 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors text-sm"
              >
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <button
              ...
              className="w-full px-6 py-4 bg-gradient-to-r from-amber-500 to-yellow-600 text-white font-semibold rounded-lg hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">Your Citations</h2>
            ...
            {citations.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-80 text-gray-400">
                ...
                <p className="text-lg font-medium">No citations yet</p>
                <p className="text-sm text-center">Use the form to generate accurate APA citations instantly</p>
              </div>
            ) : (
              <div className="space-y-4 max-h-96 overflow-y-auto">
                {citations.map((citation) => (
                  <div key={citation.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        ...
                        {citation.verified && (
                          <CheckCircle className="w-4 h-4 text-green-500" title="AI-Verified" />
                        )}
                      </div>
                    ...
                    <div className="mb-3">
                      <h4 className="text-sm font-medium text-gray-900 mb-2">Reference List Entry:</h4>
                      <p className="text-sm text-gray-700 leading-relaxed font-mono bg-gray-50 p-2 rounded">
        ...
        <div className="mt-12 grid md:grid-cols-4 gap-6">
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-600">AI processes and formats citations in seconds</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              <CheckCircle className="w-6 h-6 text-green-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">AI-Verified Accuracy</h3>
            <p className="text-sm text-gray-600">Human-verified templates ensure APA compliance</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-600">Import multiple citations from files or databases</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mx-auto mb-4">
              <History className="w-6 h-6 text-purple-600" />
            </div>
            <h3 className="font-semibold text-gray-900 mb-2">Citation History</h3>
            <p className="text-sm text-gray-600">Saves your citations for easy access and reuse</p>
          </div>
        </div>
      </div>
    </div>
