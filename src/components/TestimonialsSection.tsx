...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-br from-blue-50 to-teal-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-24">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <motion.button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-gradient-to-r from-blue-500 to-teal-400 rounded-full flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 -ml-6"
          ...
          <motion.button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-gradient-to-r from-blue-500 to-teal-400 rounded-full flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 -mr-6"
            whileHover={{ scale: 1.1, boxShadow: '0 0 20px rgba(58, 134, 255, 0.5)' }}
            whileTap={{ scale: 0.9 }}
          >
          ...
          <div className="relative h-96 overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="bg-white rounded-3xl p-8 shadow-lg max-w-2xl w-full relative">
                  {/* Quote Icon */}
                  <motion.div
                    className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-r from-blue-500 to-teal-400 rounded-full flex items-center justify-center"
                    animate={{
                      boxShadow: [
                  ...
                  {/* Testimonial Text */}
                  <motion.blockquote
                    className="text-lg text-gray-900 leading-relaxed mb-6 italic"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  {/* Highlight Badge */}
                  <motion.div
                    className="inline-block bg-gradient-to-r from-blue-500/10 to-teal-400/10 border border-blue-500/20 rounded-full px-4 py-2 mb-6"
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
